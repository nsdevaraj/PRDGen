          ...
          <div className="lg:col-span-2">
            {marketResearch ? (
              <div className="bg-white rounded-xl shadow-lg p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      ...
                      disabled={isPosting || !githubToken || !githubRepo}
                      className="px-4 py-2 bg-gray-800 text-white text-sm font-medium rounded-lg hover:bg-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center space-x-2"
                    >
                      {isPosting ? (
                        <>
                          <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
                ...
                <div className="prose prose-lg max-w-none" ref={markdownRef}>
                  <ReactMarkdown
